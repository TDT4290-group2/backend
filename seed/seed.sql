...
INSERT INTO "Notification" ("Id", "UserId", "Title", "Message", "CreatedAt", "IsRead")
VALUES  
    -- User 1 notifications
    ('11111111-1111-1111-1111-111111111111', 
     '12345678-1234-5678-1234-567812345678', 
     'High Dust Levels Detected', 
     '', 
     NOW() - INTERVAL '2 days', 
     FALSE),
    ...
    ('22222222-2222-2222-2222-222222222222', 
     '12345678-1234-5678-1234-567812345678', 
     'Noise Level Warning', 
     'Noise levels exceeded 85dB for 30 minutes', 
     NOW() - INTERVAL '1 day', 
     TRUE),
    ...
    ('44444444-4444-4444-4444-444444444444', 
     ...
     'Your daily exposure limits are within safe ranges', 
